			...
			<div class="col-xs-12" style="margin-top:10px;">  
				<div class="col-xs-8 col-xs-offset-2 text-center" style="background: #f8f8f8; border-radius: 10px; box-shadow: 0 1px 47px rgb(0, 0, 0); ">
					...
					<div class="form-group">
						<input type="text" class="form-control" placeholder="Nama akun timesheet (Email)" id="busername" name="busername" onkeypress="bkey();">
					</div>
					<div class="form-group">
					...
					<div class="form-group" id="btimeform">
						...
						<input type="number" class="form-control" placeholder="Hari" min="0" onkeypress="binputharga();" id="bharga" name="bharga"></div>
						...
						<div class="form-group"><label for="" id="blabelhari"> </label> <label for="">Hari</label></div>
                ...
                function (r){
                  ...
                  if (r['a']===null || parseInt(r['a'])===0 || r['a'].length===0){
                      ...
                      $.each(r['a'], function (bdataa, bdatab) {
                          ...
                          bvartable += '<td>'+bdatab.d+' Hari</td>';
                          bvartable += '<td><div class="btn-group">';
                          bvartable += '<a class="btn btn-xs btn-like" href="{{action('k@a')}}/'+bdatab.id+'" style="color: #8e8e8e!important; cursor: pointer;"><span class="glyphicon glyphicon-time"></span></a>';
                          bvartable += '<a class="btn btn-xs btn-like" onclick="btime(1, '+bdatab.id+');" id="btime'+bdatab.id+'" style="color: #8e8e8e!important; cursor: pointer;">Perpanjang</a></div></td>';
                          bvartable += '</tr>';
                      });
                  } 
