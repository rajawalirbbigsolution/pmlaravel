		...
		<td>
			<div class="col-xs-12" style="margin-top:10px;">  
				<div class="col-xs-8 col-xs-offset-2 text-center" style="background: #f8f8f8; border-radius: 10px; box-shadow: 0 1px 47px rgb(0, 0, 0); ">
					<div class="form-group text-left" style="margin-top: 10px !important; "> <a href="{{action('d@a')}}"><span class="glyphicon glyphicon-arrow-left" style="color: #8e8e8e;!important;"></span></a></div>
					<h6>RIwayat 	{{$c}}</h6> 
                ...
                function (r){
                    ...
                    if (r['b']===null || parseInt(r['b'])===0 || r['b'].length===0) {
                        ...
                        $.each(r['b'], function (fa, fb) {
                            ...
                            varb += '<td><a href="{{action('d@i')}}/'+fb.id+'"><span class="glyphicon glyphicon-search" style="color: #8e8e8e !important;"></span></a> </td>';
                            varb += '</tr>';
                        });
                    }
                    varb += '</tbody>';
