...
+ function(a) {
    ...
    function b(b) {
        return this.each(function() {
            ...
            f || d.data("bs.validator", f = new c(this, e)), "string" == typeof b && f[b]()
        })
    }
    var c = function(b, c) {
    ...
    c.DEFAULTS = {
        ...
        var e = [],
            f = ([c.VALIDATORS.native], a.Deferred()),
            g = this.options;
        return b.data("bs.validator.deferred") && b.data("bs.validator.deferred").reject(), b.data("bs.validator.deferred", f), a.each(c.VALIDATORS, a.proxy(function(a, c) {
            ...
            a.get(b.data("remote"), [b.attr("name"), b.val()].join("=")).fail(function(a, b, c) {
                e.push(d("remote") || c)
            }).always(function() {
                f.resolve(e)
            })
        ...
        window.clearTimeout(a.data("bs.validator.timeout")), a.data("bs.validator.timeout", window.setTimeout(b, this.options.delay))
    };
